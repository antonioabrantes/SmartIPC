...
public class GruposKind8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grupos_kind8);

        listView=(ListView)findViewById(R.id.listViewGruposKind8);
        toolbar = (Toolbar) findViewById(R.id.toolbarKind8);
        ...
        adapter = new ArrayAdapter(GruposKind8.this, android.R.layout.simple_list_item_1,mensagens);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    if (array_proximo[position]==0) {
                        ...
                        Intent intent = new Intent(GruposKind8.this, GruposKind9.class);
    ...
    public void pesquisa(){
        Intent intent = new Intent(GruposKind8.this,Pesquisa.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        //finish();
    }
    ...
    public void configuraIdiomas(){
        Intent intent = new Intent(GruposKind8.this,ChooseIdiomas.class);
        startActivity(intent);
        finish();
    }

    public void vaParaTelaInicial(){
        Intent intent = new Intent(GruposKind8.this,MainActivity.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        finish();
    }
    ...
    public void TelaAbout(){
        Intent intent = new Intent(GruposKind8.this,About.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        finish();
    }
