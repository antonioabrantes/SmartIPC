...
public class GruposKind6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grupos_kind6);

        listView=(ListView)findViewById(R.id.listViewGruposKind6);
        toolbar = (Toolbar) findViewById(R.id.toolbarKind6);
        ...
        adapter = new ArrayAdapter(GruposKind6.this, android.R.layout.simple_list_item_1,mensagens);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    if (array_proximo[position]==0) {
                        ...
                        Intent intent = new Intent(GruposKind6.this, GruposKind7.class);
    ...
    public void pesquisa(){
        Intent intent = new Intent(GruposKind6.this,Pesquisa.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        //finish();
    }
    ...
    public void configuraIdiomas(){
        Intent intent = new Intent(GruposKind6.this,ChooseIdiomas.class);
        startActivity(intent);
        finish();
    }

    public void vaParaTelaInicial(){
        Intent intent = new Intent(GruposKind6.this,MainActivity.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        finish();
    }
    ...
    public void TelaAbout(){
        Intent intent = new Intent(GruposKind6.this,About.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        finish();
    }
