...
public class GruposKind0 extends AppCompatActivity {
    private ListView listView;
    private ArrayList<String> mensagens;
    private ArrayAdapter<String> adapter;
    private int proximo_grupos_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grupos_kind0);
        toolbar = (Toolbar) findViewById(R.id.toolbarKind0);
        ...
        listView=(ListView)findViewById(R.id.listViewGruposKind0);
        mensagens = new ArrayList<String>();
        adapter = new ArrayAdapter(GruposKind0.this, android.R.layout.simple_list_item_1,mensagens);
        ...
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    array_grupos[count_proximo]=str;
                    str = str + " " + descricao;
                    mensagens.add(str);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    if (array_proximo[position]==0) {
                        ...
                        Intent intent = new Intent(GruposKind0.this, GruposKind1.class);
    ...
    public void pesquisa(){
        Intent intent = new Intent(GruposKind0.this,Pesquisa.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        //finish();
    }
    ...
    public void configuraIdiomas(){
        Intent intent = new Intent(GruposKind0.this,ChooseIdiomas.class);
        startActivity(intent);
        finish();
    }

    public void vaParaTelaInicial(){
        Intent intent = new Intent(GruposKind0.this,MainActivity.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        finish();
    }
    ...
    public void TelaAbout(){
        Intent intent = new Intent(GruposKind0.this,About.class);
        intent.putExtra("idioma", idioma);
        startActivity(intent);
        finish();
    }
